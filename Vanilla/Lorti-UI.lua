-- This goes for both LortiUI and LortiUI-Remake.
-- Go into your LortiUI or LortiUI-Remake Addon folder and delete the entire script.
-- Copy the same codes as it was there before you deleted the old and paste the new codes below in.
-- Save your file, refresh your UI in game or restart WoW. To refresh, just type in the chat box ( /reload ) and hit enter.
