// With ElvUI, choose Import, then copy and paste these codes
// This profile is by Naowh and was modified by me for me, but can be refitted to your own likes

{
    ...
    ["movers"] = {
        ["AlertFrameMover"] = "BOTTOMRIGHT,UIParent,BOTTOMRIGHT,-250,345",
        ["AltPowerBarMover"] = "BOTTOM,UIParent,BOTTOM,0,59",
        ...
        ["BNETMover"] = "TOPLEFT,UIParent,TOPLEFT,4,-73",
        ["BelowMinimapContainerMover"] = "TOPRIGHT,ElvUIParent,TOPRIGHT,-366,-346",
        ["BossButton"] = "BOTTOM,UIParent,BOTTOM,163,473",
        ["BossHeaderMover"] = "BOTTOMRIGHT,ElvUIParent,BOTTOMRIGHT,-390,393",
        ["BuffsMover"] = "TOPRIGHT,ElvUIParent,TOPRIGHT,-193,-5",
        ["ClassBarMover"] = "BOTTOM,UIParent,BOTTOM,-18,258",
        ["ComboBarMover"] = "BOTTOM,ElvUIParent,BOTTOM,0,325",
        ["DebuffsMover"] = "TOPRIGHT,ElvUIParent,TOPRIGHT,-193,-148",
        ["DurabilityFrameMover"] = "BOTTOMLEFT,UIParent,BOTTOMLEFT,425,38",
        ["ElvAB_1"] = "BOTTOM,ElvUIParent,BOTTOM,0,17",
        ["ElvAB_10"] = "BOTTOM,UIParent,BOTTOM,0,191",
        ["ElvAB_2"] = "BOTTOM,ElvUIParent,BOTTOM,-263,12",
        ["ElvAB_3"] = "BOTTOM,UIParent,BOTTOM,262,145",
        ["ElvAB_4"] = "BOTTOM,UIParent,BOTTOM,261,15",
        ["ElvAB_5"] = "BOTTOM,UIParent,BOTTOM,0,88",
        ["ElvAB_6"] = "BOTTOM,UIParent,BOTTOM,-128,195",
        ["ElvAB_7"] = "BOTTOM,UIParent,BOTTOM,-63,170",
        ["ElvAB_8"] = "BOTTOM,UIParent,BOTTOM,-62,170",
        ["ElvAB_9"] = "BOTTOM,UIParent,BOTTOM,-96,192",
        ...
        ["ElvUF_PartyMover"] = "BOTTOMRIGHT,UIParent,BOTTOMRIGHT,-494,98",
        ["ElvUF_PetCastbarMover"] = "TOPLEFT,ElvUIParent,TOPLEFT,141,-4",
        ["ElvUF_PetMover"] = "BOTTOMLEFT,UIParent,BOTTOMLEFT,572,270",
        ["ElvUF_PlayerCastbarMover"] = "BOTTOM,ElvUIParent,BOTTOM,0,226",
        ["ElvUF_PlayerMover"] = "BOTTOM,ElvUIParent,BOTTOM,-284,322",
        ["ElvUF_Raid40Mover"] = "TOPLEFT,UIParent,TOPLEFT,4,-187",
        ["ElvUF_RaidMover"] = "TOPLEFT,UIParent,TOPLEFT,93,-187",
        ...
        ["ElvUIBagMover"] = "BOTTOMRIGHT,UIParent,BOTTOMRIGHT,-236,264",
        ["ExperienceBarMover"] = "TOP,ElvUIParent,TOP,0,-21",
        ["GMMover"] = "TOPLEFT,UIParent,TOPLEFT,278,-51",
        ["LeftChatMover"] = "BOTTOMLEFT,UIParent,BOTTOMLEFT,4,23",
        ["LootFrameMover"] = "TOP,ElvUIParent,TOP,-192,-448",
        ["LossControlMover"] = "BOTTOM,UIParent,BOTTOM,0,393",
        ["MawBuffsBelowMinimapMover"] = "TOP,UIParent,TOP,0,-4",
        ["MicrobarMover"] = "BOTTOMRIGHT,UIParent,BOTTOMRIGHT,-370,15",
        ["MinimapMover"] = "TOPRIGHT,ElvUIParent,TOPRIGHT,-5,-5",
        ["ObjectiveFrameMover"] = "TOPRIGHT,ElvUIParent,TOPRIGHT,-54,-200",
        ["PetAB"] = "BOTTOM,UIParent,BOTTOM,0,119",
        ["PlayerPowerBarMover"] = "BOTTOM,ElvUIParent,BOTTOM,0,370",
        ["ReputationBarMover"] = "TOP,ElvUIParent,TOP,0,-35",
        ["RightChatMover"] = "BOTTOMRIGHT,UIParent,BOTTOMRIGHT,-4,363",
        ["ShiftAB"] = "TOPLEFT,ElvUIParent,BOTTOMLEFT,4,768",
        ["TalkingHeadFrameMover"] = "TOP,UIParent,TOP,0,-18",
        ["TargetPowerBarMover"] = "BOTTOM,ElvUIParent,BOTTOM,311,316",
        ["TooltipMover"] = "TOP,UIParent,TOP,415,-904",
        ["TopCenterContainerMover"] = "TOP,ElvUIParent,TOP,0,-55",
        ["TorghastChoiceToggle"] = "BOTTOM,ElvUIParent,BOTTOM,-16,359",
        ["TotemBarMover"] = "BOTTOMLEFT,ElvUIParent,BOTTOMLEFT,4,216",
        ["VOICECHAT"] = "TOPLEFT,UIParent,TOPLEFT,249,-165",
        ["VehicleLeaveButton"] = "BOTTOM,UIParent,BOTTOM,0,153",
        ["VehicleSeatMover"] = "BOTTOMLEFT,UIParent,BOTTOMLEFT,515,77",
        ["ZoneAbility"] = "BOTTOM,UIParent,BOTTOM,166,158",
    },
    ["nameplates"] = {
        ["colors"] = {
